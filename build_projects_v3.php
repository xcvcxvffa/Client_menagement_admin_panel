...
<div class="h-full flex flex-col bg-[#fdfaf7]">
            ...
            <div class="flex-shrink-0 w-[420px] bg-[#f9fafb] rounded-2xl border border-gray-100 flex flex-col max-h-full">
                ...
                <div class="flex-1 overflow-y-auto p-3 space-y-4">
                    @forelse($colProjects as $project)
                        ...
                        <!-- Project Card -->
                        <div wire:key="project-{{ $project->id }}" wire:click="viewProject({{ $project->id }})" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 cursor-pointer hover:border-gray-200 hover:shadow-md transition-all group">
    ...
    <div x-show="$wire.isDrawerOpen" class="fixed inset-0 z-50 overflow-hidden" style="display: none;">
        ...
        <!-- Drawer Panel -->
        <div class="fixed inset-y-0 right-0 flex w-full {{ (!$selectedProjectId || $isEditMode) ? 'max-w-[450px]' : 'max-w-[95vw] lg:max-w-[90vw] xl:max-w-[1300px]' }}">
                        ...
                        <div class="flex-1 overflow-y-auto p-6 bg-white space-y-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <label class="relative flex cursor-pointer rounded-lg border bg-orange-50 border-orange-500 p-3 shadow-sm focus:outline-none">
                                        <input type="radio" name="project_type" value="one_off" class="sr-only" checked>
                                    ...
                                    <label class="relative flex cursor-pointer rounded-lg border border-gray-200 bg-white p-3 shadow-sm hover:border-gray-300 focus:outline-none">
                                        <input type="radio" name="project_type" value="retainer" class="sr-only">
                                        <span class="flex flex-1">
                                            <span class="flex flex-col">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <div class="flex justify-between items-center mb-1">
                                        ...
                                        <a href="#" class="text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center"><span class="mr-1">+</span> New client</a>
                                    </div>
                                    <select wire:model="client_id" required class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm text-sm text-gray-500 p-2.5">
                                ...
                                <div>
                                    ...
                                    <select wire:model="status" required class="w-full rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm text-sm text-gray-900 font-medium p-2.5">
                                        <option value="planning">New</option>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="date" wire:model="started_at" class="w-full pl-9 rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm text-sm text-gray-500 p-2.5">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-[13px] font-bold text-gray-700 mb-1">&nbsp;</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                        </div>
                                        <input type="date" wire:model="due_at" class="w-full pl-9 rounded-lg border-gray-300 focus:border-orange-500 focus:ring-orange-500 shadow-sm text-sm text-gray-500 p-2.5">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-2">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <a href="#" class="text-xs font-bold text-orange-600 hover:text-orange-700">Add</a>
                                </div>
                            </div>

                            <div class="pt-2 pb-6">
                                <div class="flex justify-between items-start mb-3">
                                    <h4 class="text-sm font-bold text-gray-900">Assign Team Members</h4>
                                    <a href="#" class="text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center"><span class="mr-1">+</span> Add</a>
                                </div>
                                <div class="border border-dashed border-gray-300 rounded-lg p-4 flex items-center justify-center bg-gray-50">
                                    <p class="text-[11px] text-gray-500 font-medium">No team members assigned yet.</p>
                                </div>
                            </div>
                        </div>
...
file_put_contents('d:\Client_menagement_admin\resources\views\livewire\projects\list-projects.blade.php', $content);
echo "list-projects.blade.php fully updated with narrow create form, wide view drawer, and fixed tabs.\n";
